...
_R2_INTRO = (
    ...
    "нашего Конкурса в Кубе!\n\n"
    "Внимание, начинаем второй тур!\n\n"
    "Выбери тему, ответь правильно — идёшь дальше. Ошибёшься — тема закрывается, "
    "но баллы не отнимаются.\n\n"
    "Мы ж не звери, мы Q CLUB. Начинаем?"
)

_R2_FINISHED_FOLLOWUP = (
    "Отлично, ты молодец!\n\n"
    "Это была последняя тема тура — спасибо за твои ответы!\n\n"
    "Результаты пришлём в письме <b>25.05</b> на указанную почту.\n\n"
    "А пока загляни в финальный тур — старт <b>20.05</b>."
)

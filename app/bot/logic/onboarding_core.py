...
_EMAIL_ACCEPTED = (
    ...
    "📆Тебя будут ждать три тура: <b>14.05</b>, <b>18.05</b> и <b>20.05</b> — мы пришлём напоминания, "
    "чтобы ты точно не пропустил начало.\n\n"
    "Участвуй в каждом туре и зарабатывай баллы. Желаем тебе удачи!"
)
